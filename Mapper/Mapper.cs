    ...
    public static class MapTo
    {
        public static UserBaseDto UserBaseDto(UserBase user)
        {
            UserBaseDto User = new()
            {
                ...
                UnlockedCommonSlots = user.UnlockedCommonSlots,
                UnlockedRareSlots = user.UnlockedRareSlots,
                UnlockedEpicSlots = user.UnlockedEpicSlots,
                UnlockedLegendarySlots = user.UnlockedLegendarySlots,
