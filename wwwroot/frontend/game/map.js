...
const locations = {
    ...
    "riverfall": [
        { name: "A", x: 168, y: 346, active: false, bgs: "bgs_riverfall_tall_pine" },
        { name: "B", x: 80, y: 384, active: false, bgs: "bgs_riverfall_tall_pine" },
        { name: "C", x: 64, y: 456, active: false, bgs: "bgs_riverfall_water" },
        { name: "D", x: 160, y: 496, active: false, bgs: "bgs_riverfall_water" },
        { name: "E", x: 247, y: 512, active: false, bgs: "bgs_riverfall_water" },
        { name: "F", x: 392, y: 520, active: false, bgs: "bgs_riverfall_water" },
        { name: "G", x: 295, y: 431, active: false, bgs: "bgs_riverfall_tall_pine" },
        { name: "H", x: 401, y: 395, active: false, bgs: "bgs_riverfall_tall_pine" },
        { name: "I", x: 568, y: 390, active: false, bgs: "bgs_riverfall_tall_pine" },
        { name: "J", x: 642, y: 440, active: false, bgs: "bgs_riverfall_tall_pine" },
        { name: "K", x: 611, y: 536, active: false, bgs: "bgs_riverfall_tall_pine" },
        { name: "L", x: 693, y: 354, active: false, bgs: "bgs_riverfall_cave" },
        { name: "M", x: 804, y: 376, active: false, bgs: "bgs_riverfall_cave" },
        { name: "N", x: 709, y: 255, active: false, bgs: "bgs_riverfall_cave" },
